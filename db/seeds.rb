...
post1 = Post.create(title: 'I am pissed!', body: "I have done as much as I was able to learn this week.  I spent four days basically debugging ruby code and got to do ajax for 1/2 of the last day - barely.  I never even got to try any of the gems you put out and testing?!!  HAH!  I never ever got to do that.  SO if you don't like that I didn't test then you need to rethink how you made the curriculum.", user_id: alex.id)
